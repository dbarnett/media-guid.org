...
from media_guid.model import DBSession
from media_guid.tests import setup_db, teardown_db
...
class ModelTest(object):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.obj = self.the_class(**new_attrs)
    ...
    def test_query_obj(self):
        ...
        obj = DBSession.query(self.the_class).one()
